...
export const sampleContentItems: ContentItem[] = [
  {
    ...
    description:
      'Learn the basics of effective communication that will help you succeed in any job.',
    resources: [
      {
...
export const sampleAdItems: AdItem[] = [
  {
    ...
    description:
      'Get certified as a security guard with our accredited online course. Special discount for WorkWise SA members.',
    cta: {
      primary: {
        text: 'Enroll Now',
  ...
  },
  {
    ...
    description:
      "Join the QuickMart team! We're hiring for multiple positions at our stores across South Africa.",
    cta: {
      primary: {
        text: 'Apply Now',
