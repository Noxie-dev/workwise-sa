  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Explore career resources, CV building guides, AI tools help, and more support options for your job search in South Africa."
        />
      </Helmet>
      ...
      <main className="flex-grow bg-light py-8 dark:bg-gray-950">
        <div className="container mx-auto px-4 dark:bg-gray-900 dark:text-white">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="text-muted dark:text-gray-300 max-w-2xl mx-auto">
              Access guides, help documentation, and support for all WorkWise SA features including
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Professional templates to make your CV stand out
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="mb-4">
              ...
              <Card>
                ...
                <CardContent>
                  <p className="mb-4">
                    Learn how to answer common interview questions for positions like cashier,
                    general worker, security guard, and more.
                  </p>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="mb-4">
                    Discover resources for skill development and advancement opportunities for
              ...
              <Card>
                ...
                <CardContent>
                  <p className="mb-4">
                    Learn effective techniques to find and secure positions as a cashier, security
                    guard, domestic worker, or other essential jobs.
                  </p>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="mb-4">
                    Build the professional skills employers value most for entry-level positions in
                    South Africa.
                  </p>
