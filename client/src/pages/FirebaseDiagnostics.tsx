            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p>
                    Firebase Client Ops:{' '}
                    {firebaseStatus.clientOpsEnabled ? 'Enabled' : 'Demo mode (disabled)'}
                  </p>
                </div>

                <Button onClick={runDiagnostics} disabled={isRunningTests} className="w-full">
          ...
          <CardContent>
            <div className="space-y-4">
              <div>
                ...
                <p>
                  Make sure all required Firebase configuration variables are set in your{' '}
                  <code>.env</code> file:
                </p>
              ...
              <div>
                ...
                <ul className="list-disc pl-5 mt-2">
                  <li>
                    Make sure Firebase emulators are running with{' '}
                    <code>firebase emulators:start</code>
                  </li>
                  <li>
                    Verify that <code>VITE_USE_FIREBASE_EMULATORS=true</code> is set in your{' '}
                    <code>.env</code> file
                  </li>
                  <li>
                    Check that the emulator ports match the ones in your code (Auth: 9099,
              ...
              <div>
                ...
                <ul className="list-disc pl-5 mt-2">
                  <li>
                    Verify that Email/Password authentication is enabled in your Firebase console
                  </li>
