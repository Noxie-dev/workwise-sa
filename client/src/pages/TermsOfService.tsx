          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="mb-4 text-gray-700 leading-relaxed">
                ...
                These Terms constitute a legally binding agreement between you and WorkWise SA.
              </p>
              <p className="mb-4 text-gray-700 leading-relaxed">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 mb-6 text-gray-700 space-y-1">
                ...
                <li>
                  <strong>Employers:</strong> Companies and organizations posting job opportunities
                </li>
                <li>
                  <strong>Recruiters:</strong> Professional recruitment agencies
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                <li>
                  <strong>Fees:</strong> Certain features may require payment of fees. All fees are
                  non-refundable unless otherwise stated.
                </li>
                <li>
                  <strong>Billing:</strong> You agree to pay all charges incurred by your account.
                  We may change our fees at any time with reasonable notice.
                </li>
                <li>
                ...
                <li>
                  <strong>Payment Methods:</strong> We accept various payment methods as displayed
                  during checkout.
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4 text-gray-700 leading-relaxed">
                ...
                postings. We are not responsible for the conduct of users or the content they post.
              </p>
              <p className="mb-4 text-gray-700 leading-relaxed">
              ...
              <p className="mb-4 text-gray-700 leading-relaxed">
                To the maximum extent permitted by law, WorkWise SA shall not be liable for any
            ...
            <section className="mb-8">
              ...
              <p className="mb-4 text-gray-700 leading-relaxed">
                ...
                Africa, without regard to its conflict of law provisions. Any disputes arising from
            ...
            <div className="mt-12 p-4 bg-blue-50 border-l-4 border-blue-400 rounded">
              <p className="text-sm text-blue-800">
                <strong>Note:</strong> These terms of service are designed to comply with South
                African law. For specific legal advice regarding your rights and obligations, please
