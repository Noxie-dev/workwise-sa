...
export const mockCategories: Category[] = [
  ...
  {
    id: 2,
    name: 'Construction General Worker',
...
export const mockCompanies: Company[] = [
  {
    ...
    description:
      'A leading tech company specializing in software development and digital transformation.',
  ...
  },
  {
    ...
    logo: DEFAULT_COMPANY_LOGO,
    description:
      'A financial services firm providing investment management and financial advisory services.',
  ...
  },
  {
    ...
    logo: DEFAULT_COMPANY_LOGO,
    description:
      'A marketing and advertising agency specializing in digital marketing and brand development.',
    location: 'Johannesburg, Gauteng',
    industry: 'Marketing',
  ...
  },
  {
    ...
    logo: DEFAULT_COMPANY_LOGO,
    description:
      'A healthcare provider operating clinics and medical facilities across South Africa.',
...
export const mockJobs: Job[] = [
  ...
  },
  {
    ...
    category: 'Finance',
    description:
      'Join our team as a financial analyst to help clients make informed investment decisions...',
