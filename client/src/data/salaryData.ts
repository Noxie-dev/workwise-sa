...
export const jobLevelDescriptions = {
  entry:
    'Entry level positions typically require minimal experience (0-2 years) and may involve basic tasks under supervision.',
  mid: 'Mid-level positions usually require some experience (2-5 years) and involve more responsibility and independent work.',
  senior:
    'Senior positions typically require significant experience (5+ years) and may involve supervisory responsibilities.',
};
...
export const jobCategoryInfo = {
  'General Worker': {
    description:
      'Basic labor roles across various industries requiring minimal specialized skills.',
