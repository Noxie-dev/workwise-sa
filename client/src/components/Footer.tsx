        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div className="h-10 mb-4 flex items-center">
              <div className="flex items-center">
                ...
                <span className="text-xl font-bold text-primary">
                  WORK<span className="text-accent">WISE.SA</span>
                </span>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/jobs" className="text-primary hover:text-accent">
                  Browse Jobs
                </Link>
              </li>
              <li>
                <Link href="/resources" className="text-primary hover:text-accent">
                  Career Resources
                </Link>
              </li>
              <li>
                <Link href="/resources/cv-templates" className="text-primary hover:text-accent">
                  CV Templates
                </Link>
              </li>
              <li>
                <Link href="/resources/interview-tips" className="text-primary hover:text-accent">
                  Interview Tips
                </Link>
              </li>
              <li>
                <Link href="/resources/salary-guide" className="text-primary hover:text-accent">
                  Salary Guide
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/employers/post-job" className="text-primary hover:text-accent">
                  Post a Job
                </Link>
              </li>
              <li>
                <Link href="/employers/dashboard" className="text-primary hover:text-accent">
                  Employer Dashboard
                </Link>
              </li>
              <li>
                <Link href="/employers/solutions" className="text-primary hover:text-accent">
                  Recruitment Solutions
                </Link>
              </li>
              <li>
                <Link href="/employers/pricing" className="text-primary hover:text-accent">
                  Pricing
                </Link>
              </li>
              <li>
                <Link href="/employers/success-stories" className="text-primary hover:text-accent">
                  Success Stories
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/faq" className="text-primary hover:text-accent">
                  FAQ
                </Link>
              </li>
            </ul>
