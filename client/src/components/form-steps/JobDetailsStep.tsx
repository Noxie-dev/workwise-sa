            ...
            {canShowAIDialog ? (
              <Dialog>
                <DialogTrigger asChild>
                  <Button variant="outline" className="flex items-center gap-1.5" type="button">
                ...
                <DialogContent>
                  ...
                  <DialogDescription>
                    Let AI help you create a compelling job description based on the information
                    you've provided.
                  </DialogDescription>

                  <div className="grid gap-4 py-4">
                    <p>
                      Position: <strong>{values.title}</strong>
                    </p>
                    <p>
                      Category: <strong>{values.category}</strong>
                    </p>
                    ...
                    <Tabs defaultValue="basic">
                      ...
                      <TabsContent value="basic" className="p-4 border rounded-md mt-2">
                        <p>
                          Generate a simple job description with standard responsibilities and
                          requirements.
                        </p>
                      </TabsContent>
                      <TabsContent value="detailed" className="p-4 border rounded-md mt-2">
                        <p>
                          Generate a comprehensive job description with detailed responsibilities,
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="space-y-4">
          <FormField
            ...
            label="Salary Range"
            error={
              (touched.salaryMin || touched.salaryMax) && (errors.salaryMin || errors.salaryMax)
            }
