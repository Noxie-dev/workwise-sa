    ...
    if (
      ...
      return (
        <div
          ...
          dangerouslySetInnerHTML={{ __html: marked(sanitizedMarkdown || '') }}
        />
      );
    }
      ...
      fields: [
        ...
        { label: 'Category', value: values.category },
        {
          ...
          value: values.jobType
            ? values.jobType.charAt(0).toUpperCase() + values.jobType.slice(1)
            : '',
        },
  ...
  return (
    <div className="space-y-8">
      ...
      <p className="text-gray-600">
        Please review all the information carefully before submitting. You can click "Edit" to go
        ...
        <Card key={group.title}>
          ...
          <CardContent className="space-y-3">
            {group.fields.map(field => (
              <div
                key={field.label}
                className="pt-3 first:pt-0 border-t border-gray-100 first:border-t-0"
              >
