    ...
    <div className="space-y-6">
      ...
      >
        <div className="space-y-2">
            ...
            <Button
              ...
              onClick={() =>
                onInitiateAIAssist(
                  ...
                  {
                    aiDescriptionType: values.aiDescriptionType,
                    aiCustomPrompt: values.aiCustomPrompt,
                  }
                )
              }
              disabled={!canUseAI}
              type="button"
              title={!canUseAI ? 'Enter title & category in previous step' : 'Generate with AI'}
            >
          ...
          {showMarkdownHelp && (
            <Card className="bg-gray-50 text-xs">
              <CardContent className="space-y-1 p-3">
                <p>
                  <code># Heading 1</code>, <code>## Heading 2</code>, etc.
                </p>
                <p>
                  <code>**bold text**</code> for <strong>bold text</strong>
                </p>
                <p>
                  <code>*italic text*</code> or <code>_italic text_</code> for <em>italic text</em>
                </p>
                <p>
                  <code>- List item 1</code>
                  <br />
                  <code>- List item 2</code> for bullet points
                </p>
                <p>
                  <code>1. Ordered item 1</code>
                  <br />
                  <code>2. Ordered item 2</code> for numbered lists
                </p>
                <p>
                  <code>[link text](https://example.com)</code> for links
                </p>
                <p>
                  <code>---</code> for a horizontal rule
                </p>
              </CardContent>
            </Card>
          )}
          <Textarea
            ...
            placeholder="Describe the position, responsibilities, culture, etc. Markdown is supported."
          />
        </div>
      </FormField>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <FormField
          ...
          hint="List main duties as bullet points. Markdown supported."
        >
          <Textarea
            id="job-responsibilities"
...
- Maintain inventory records"
        ...
        <FormField
          id="job-requirements"
          label="Qualifications & Skills (Optional)"
          hint="List specific skills, experience, or education. Markdown supported."
        >
          <Textarea
            id="job-requirements"
            ...
            className="min-h-[150px] font-mono text-sm"
            placeholder="- Minimum 2 years experience in X
