  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      <div className="text-center">
        <h1 className="text-3xl font-bold mb-4">Client-Server Rendering Utilities Demo</h1>
        <p className="text-gray-600 max-w-2xl mx-auto">
          This page demonstrates utilities that prevent hydration mismatches and ensure consistent
          rendering between server and client environments.
        </p>
      </div>
