        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <Input
                id="ruleName"
                {...register('ruleName')}
                placeholder="e.g., Gauteng Tech Roles"
              />
              {errors.ruleName && (
                <p className="text-sm text-red-600 mt-1">{errors.ruleName.message}</p>
              )}
            </div>
            <div className="flex items-center space-x-2 pt-6">
              ...
              />
              <Label htmlFor="status">{watch('status') === 'Active' ? 'Active' : 'Inactive'}</Label>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              />
              {errors.targetJobType && (
                <p className="text-sm text-red-600 mt-1">{errors.targetJobType.message}</p>
              )}
            </div>
          </div>
          ...
          <div>
            ...
            />
            {errors.ctaLink && (
              <p className="text-sm text-red-600 mt-1">{errors.ctaLink.message}</p>
            )}
          </div>
