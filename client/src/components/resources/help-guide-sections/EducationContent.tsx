    ...
    <div className="space-y-4">
      ...
      <div className="border rounded p-4 bg-gray-50 mt-4">
        ...
        <p className="text-sm mt-1">
          Key subjects: Mathematics (5), English (6), Life Sciences (5), Computer Applications
          Technology (6)
        </p>
        <p className="text-sm">Overall Bachelor Pass with 4 distinctions</p>
      </div>
      <Tip>
        In South Africa, specify the type of Matric certificate (NSC, IEB) and include any NQF
        levels for qualifications where applicable.
      </Tip>
    </div>
  );
}
