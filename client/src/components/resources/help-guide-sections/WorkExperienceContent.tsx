  ...
  return (
    <div className="space-y-4">
      <ul className="list-disc pl-5 space-y-2">
        ...
        <li>
          For each position, add 3-5 bullet points describing your responsibilities and achievements
        </li>
      ...
      <div className="border rounded p-4 bg-gray-50 mt-4">
        ...
        <ul className="list-disc pl-5 text-sm space-y-1">
          <li>
            Process an average of 45 transactions daily while maintaining 100% cash drawer accuracy
          </li>
          ...
          <li>
            Organize and maintain store displays, consistently receiving positive feedback from
            management
          </li>
        </ul>
      </div>
      <Tip>
        South African employers value detailed work experience. Include contract and temporary
        positions, especially if you're early in your career.
      </Tip>
    </div>
  );
}
