...
**Commit:** `ad8ace7` (`test: prove employer dashboard isolation`)
...
**Latest execution checkpoint:** `ad8ace7` — employer job/application-list and dashboard-metric isolation verified in Pass A; score remains 28/100 and confidence remains High/medium as stated above.
...
| Type/build/tests | PASS | `pnpm run type-check`; `pnpm run build:server`; server 19 files/74 tests; client 16 files/103 tests |
