...
- `docs/project/README.md` - Main project readme
- `docs/guides/DEV_CONTAINER_README.md` - Development container guide
- `docs/reports/CODEBASE_INDEX.md` - This comprehensive codebase index
- `docs/reports/ACCESSIBILITY_IMPLEMENTATION_PLAN.md` - Accessibility plan
- `docs/reports/BACKEND_IMPROVEMENTS.md` - Backend improvement notes
- `docs/guides/BUNDLE_OPTIMIZATION_GUIDE.md` - Bundle optimization guide
- `docs/guides/CLOUDFLARE_SETUP.md` - Cloudflare configuration
- `docs/reports/COMPANIES_PAGE_DEMO.md` - Companies page demo
- `docs/guides/ENV_ANALYSIS_REPORT.md` - Environment analysis
- `docs/guides/FIREBASE_UPDATE_SUMMARY.md` - Firebase updates
- `docs/guides/NETLIFY_DEPLOYMENT_GUIDE.md` - Netlify deployment
- `docs/reports/PROFILE_IMPLEMENTATION_REPORT.md` - Profile implementation
- `docs/archive/QA_PROCESS.md` - Quality assurance process
- `docs/reports/TIERED_JOB_ACCESS_IMPLEMENTATION.md` - Job access implementation
